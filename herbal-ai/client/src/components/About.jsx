...
const About = () => {
  return (
    <div className="" id="About">
      <div className="about flex justify-center items-center p-2 w-full h-[100px] text-center">
      ...
      <div className="flex max-md:mx-auto max-md:flex-col max-md:gap-2 max-md:w-[90%] max-md:justify-center max-md:items-center mt-10 w-full justify-evenly about__images relative max-w-md:h-auto">
        <a
          href="https://github.com/jatindotdev/herbal-ai"
          className="block max-md:mx-auto max-md:w-[60%]"
          target="__blank"
        >
          <div className="bg-[#24292F] flex gap-2 flex-row justify-evenly rounded-lg px-6 py-2 w-max max-md:w-[100%] text-[#ffffff] hover:bg-[#14171b] transition-all 0.2s ease-in items-center">
            <svg
      ...
      <div className="w-full flex justify-center items-center h-auto text-justify">
        <p className="w-[90%] text-lg my-5 max-md:text-[16px]">
          <span className="w-full font-medium block text-center my-2">
            AI-Based Flora Recognition System:
          </span>
          In the realm of environmental science, the advent of Artificial
          Intelligence (AI) has brought about a paradigm shift, notably in the
          field of flora recognition. Our AI-based system expedites the
          identification of plant species by analyzing botanical images through
          a finely tuned model, often leveraging datasets like Indian Medicinal
          Plants Dataset. The core of our system involves training advanced
          neural networks, such as mobileNET V2, to ensure precise
          classification. Users can effortlessly interact with our user-friendly
          web interface, uploading images of plants for swift and accurate
          identification. The interface is further enriched with a chatbot
          feature, providing users with detailed information about recognized
          plants such as habitat, growing conditions, and potential uses. <br />
          <br />
          With a simple snapshot, users gain rapid insights into the botanical
          world around them. The integrated chatbot stands ready to respond to
          inquiries regarding plant characteristics, ecological significance,
          and even gardening tips. This innovative system not only promotes
          environmental awareness but also empowers users to make informed
          decisions about their surroundings. It facilitates accessibility to
          botanical knowledge, enabling enthusiasts, researchers, and nature
          lovers to identify and appreciate the rich diversity of plant life.
          Moreover, professionals in fields like ecology and conservation can
          utilize the system for efficient and accurate plant species
          documentation. <br /> <br />
          The AI-based flora recognition system represents a transformative tool
          in the domain of environmental science, fostering a deeper connection
          between individuals and the plant kingdom while contributing to the
          advancement of ecological research and conservation efforts.
        </p>
      </div>
    </div>
  );
